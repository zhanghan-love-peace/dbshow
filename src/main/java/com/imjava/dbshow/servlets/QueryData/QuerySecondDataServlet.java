...
@WebServlet("/second-data")
public class QuerySecondDataServlet extends HttpServlet {
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        req.setCharacterEncoding("UTF-8");
        // how to fix the utf8 problem
        resp.setContentType("text/plain;charset=UTF-8");
        PrintWriter writer = resp.getWriter();
        System.out.println("second-data servlet called");
        ...
        result = QueryData.querySecondData(sampleYear, sampleIndex, sampleCountry);
